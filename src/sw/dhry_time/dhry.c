...
/*
  ...
  printf ("\n");
*/
    Microseconds = (User_Time)  / (int)Number_Of_Runs;
    User_Time_ms = User_Time / 1000;
    Dhrystones_Per_Second =  ((int)Number_Of_Runs * 1000) / (User_Time_ms);
    Vax_Mips = ((int)Number_Of_Runs * 1000) / (1757 * User_Time_ms);
